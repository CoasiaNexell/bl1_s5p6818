...
#define AXP228_DEF_DDC1_VOL 3300000 /* VAL(uV) = 0: 1.60 ~ 3.40V, Step 100 mV, default(OTP) = 3.3V */
#define AXP228_DEF_DDC2_VOL 1200000 /* VAL(uV) = 0: 0.60 ~ 1.54V, Step 20 mV, default(OTP) = 1.25V */
#define AXP228_DEF_DDC3_VOL 1200000 /* VAL(uV) = 0: 0.60 ~ 1.86V, Step 20 mV, default(OTP) = 1.1V */
#define AXP228_DEF_DDC4_VOL 1500000 /* VAL(uV) = 0: 0.60 ~ 1.54V, Step 20 mV, default(OTP) = 1.5V */
#define AXP228_DEF_DDC5_VOL 1500000 /* VAL(uV) = 0: 1.05 ~ 2.60V, Step 50 mV, default(OTP) = 1.5V */

/* REG : DC-DC Output Voltage Set */
...
#define AXP228_REG_DCDC_WORK_MODE 0x80

#define DCDC_SYS (1<<3) /* VCC1P5_SYS(DDRIO) */
#define DCDC_DDR (1<<4) /* VCC1P5_DDR */

/* Slave Address */
#define I2C_ADDR_AXP228 (0x68 >> 1)
